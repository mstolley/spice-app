        ...
        `}>
            ...
            {blend && (
                <div>
                    ...
                    <div className='mb-1'>
                        <span className='mr-1 font-bold'>Blends:</span> {blendBlends.length ? blendBlends.map(blend => blend.name).join(', ') : 'None'}
                    </div>
                    <div className='mb-1'>
                        <span className='mr-1 font-bold'>Spices:</span> {blendSpices.length ? blendSpices.map(spice => spice.name).join(', ') : 'None'}
                    </div>
                    <div className='mb-1'>
